...
if($lastInsertId)
{
$_SESSION['msg']="Đã gửi yêu cầu hỗ trợ";
							...
							<ul>
								<li class="na-me">
									<select id="country" name="issue" class="frm-field required sect" required="">
										...
										<option value="Booking Issues">Đặt tour</option>
								...
								<li class="descrip">
									<input class="special" type="text" placeholder="Nội dung"  name="description" required="">
								</li>

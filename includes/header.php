...
<div class="top-header">
	<div class="container">
		<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
			...
			<li class="prnt"><a href="tour-history.php">Lịch sử đặt lịch</a></li>
			<li class="prnt"><a href="issuetickets.php">Yêu cầu trợ giúp</a></li>
		</ul>
...
<div class="top-header">
	<div class="container">
		...
		<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			<li class="tol">Liên hệ : 123-4568790</li>			
			<li class="tol"></li>	
			<li class="tol"></li>	
...
<div class="header">
	<div class="container">
		<div class="logo wow fadeInDown animated" data-wow-delay=".5s">
			<a href="index.php">Hệ Thống <span>Đặt Tour Du Lịch</span></a>	
		</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<?php if($_SESSION['login']){?>
							<li><a href="#" data-toggle="modal" data-target="#myModal3"> Gửi yêu cầu hỗ trợ </a>  </li>
							<?php } else { ?>
							<li><a href="enquiry.php"> Phản hồi </a>  </li>
							<?php } ?>
							<div class="clearfix"></div>
						</ul>
					</nav>

...
{	?>
							...
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Gói</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Loại</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Tính năng</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Cập nhật lúc</label>
									<div class="col-sm-8">
